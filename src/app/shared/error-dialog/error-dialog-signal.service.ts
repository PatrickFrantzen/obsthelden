    ...
    handleError(error: any) {
        ...
        switch (error.code) {
            ...
            case 'auth/weak-password':
              message = 'Das Passwort ist zu schwach. Bitte wählen Sie ein stärkeres Passwort mit mindestens 6 Zeichen.';
              break;
            case 'auth/invalid-email':
                message = 'Die eingegebene Emailadresse ist ungültig. Bitte überprüfen Sie die Eingabe.';
                break;
            default:
